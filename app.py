...
def submit():
    ...
    new_data = {
        ...
        "Phone": request.form.gett("phone_number"),
        ...
        "Account Setup": request.form.get("account_setup"),
        "Handbook": request.form.get("handbook"),
        "NDA": request.form.get("nda"),
        "Confidentiality": request.form.get("confidentiality"),
        "Conduct": request.form.get("code_of_conduct"),
        "Data Policy": request.form.get("data_protection"),
        "Additional Info": request.form.get("additional_info"),
        "Signature": request.form.get("signature"),
        "Today Date": request.form.get("today_date")
    }
    df = pd.concat([df, pd.DataFrame([new_data])], ignore_index=True)
    df.to_excel(DATA_FILE, index=True)
